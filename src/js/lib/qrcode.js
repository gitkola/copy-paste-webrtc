export const QRCode = (function (t) {
  'use strict';
  var r,
    e = function () {
      return (
    ...
    R = c(function (t, r) {
      (r.mul = function (t, r) {
        for (
          ...
          for (var o = 0; o < r.length; o++) e[n + o] ^= C(t[n], r[o]);
        return e;
      }),
        (r.mod = function (t, r) {
          for (var e = new Uint8Array(t); e.length - r.length >= 0; ) {
            for (var n = e[0], o = 0; o < r.length; o++) e[o] ^= C(r[o], n);
        ...
        (r.generateECPolynomial = function (t) {
          for (var e = new Uint8Array([1]), n = 0; n < t; n++)
            e = r.mul(e, new Uint8Array([1, P(n)]));
          return e;
        });
    });
  function T(t) {
            ...
            var i = (function (t, r) {
                for (
                  ...
                  for (var u = t[i], s = [], f = 0; f < u.length; f++) {
                    var c = u[f],
                      h = '' + i + f;
                    s.push(h), (e[h] = { node: c, lastCount: 0 }), (n[h] = {});
                    for (var g = 0; g < o.length; g++) {
                      var d = o[g];
                      e[d] && e[d].node.mode === c.mode
                        ? ((n[d][h] =
                            a(e[d].lastCount + c.length, c.mode) -
                            a(e[d].lastCount, c.mode)),
                          (e[d].lastCount += c.length))
                        : (e[d] && (e[d].lastCount = c.length),
                          (n[d][h] =
                            a(c.length, c.mode) +
                            4 +
                            K.getCharCountIndicator(c.mode, r)));
                    }
                  }
                  o = s;
                }
  ...
  function at(t, r, e) {
    ...
    return (function (t, r, e) {
      ...
      var A,
        ...
        P = 0;
      for (A = 0; A < w; A++)
        for (N = 0; N < u; N++) A < v[N].length && (B[P++] = v[N][A]);
      for (A = 0; A < g; A++) for (N = 0; N < u; N++) B[P++] = p[N][A];
      return B;
    })(n, t, r);
  }
  function it(t, r, e, n) {
    ...
    return (
      ...
      isNaN(n) && (n = E.getBestMask(h, ot.bind(null, h, e))),
      E.applyMask(n, h),
      ot(h, e, n),
      {
        modules: h,
  ...
  var ut = function (t, r) {
      ...
      return (
        void 0 !== r &&
          ((o = h.from(r.errorCorrectionLevel, h.M)),
          (e = O.from(r.version)),
          ...
          for (
            ...
            for (var h = 0; h < u; h++) {
              ...
              if (c >= s && h >= s && c < u - s && h < u - s)
                d =
                  f[
                    a[Math.floor((c - s) / i) * o + Math.floor((h - s) / i)]
                      ? 1
                      : 0
                  ];
          ...
          for (var n = '', o = 0, a = !1, i = 0, u = 0; u < t.length; u++) {
            ...
            s || a || (a = !0),
              t[u]
                ? (i++,
                  (u > 0 && s > 0 && t[u - 1]) ||
                    ((n += a ? ht('M', s + e, 0.5 + f + e) : ht('m', o, 0)),
                    (o = 0),
                    (a = !1)),
                  (s + 1 < r && t[u + 1]) || ((n += ht('h', i)), (i = 0)))
                : o++;
          }
          return n;
        })(a, o, n.margin) +
